  ...
  return (
    <Routes>
      <Route path="/" element={<React.Suspense fallback={<Loading />}>
        ...
        <Route path="/inscribe" element={<React.Suspense fallback={<Loading />}>
          <View.InscribeView />
        </React.Suspense>}></Route>
        <Route path="/ins-collection" element={<React.Suspense fallback={<Loading />}>
          <View.InsCollectionView />
        </React.Suspense>}></Route>
        <Route path="/memes" element={<React.Suspense fallback={<Loading />}>
          <View.MemesView />
        </React.Suspense>}></Route>
        ...
        <Route path="/video" element={<React.Suspense fallback={<Loading />}>
          <View.VideoView />
        </React.Suspense>}></Route>
        <Route path="*" element={<React.Suspense fallback={<Loading />}>
          <View.PageNotFound />
