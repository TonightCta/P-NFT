    ...
    >
      {cateSwiper.map((item: Cate, index: number): ReactElement => {
        return (
          ...
          >
            {rankMsg[index] && rankMsg[index].loading && (
            ...
            <div className="banner-box">
              {index <= 2 && (
                <div
                  className="rank-box"
                  style={{ backgroundColor: item.rank_color }}
                >
              ...
              <img
                src={
                  rankMsg[index]
                    ? rankMsg[index].img_urls[0]
                      ? rankMsg[index].img_urls[0].ipfs_url
                      : item.img
                    : item.img
                }
                className="alone-img"
              ...
              <div className="img-other">
                <img
                  src={
                    rankMsg[index]
                      ? rankMsg[index].img_urls[1]
                        ? rankMsg[index].img_urls[1].ipfs_url
                        : item.img_1
                      : item.img_1
                  }
                  alt=""
                ...
                <img
                  src={
                    rankMsg[index]
                      ? rankMsg[index].img_urls[2]
                        ? rankMsg[index].img_urls[2].ipfs_url
                        : item.img_2
                      : item.img_2
                  }
                  alt=""
                ...
                <img
                  src={
                    rankMsg[index]
                      ? rankMsg[index].img_urls[3]
                        ? rankMsg[index].img_urls[3].ipfs_url
                        : item.img_3
                      : item.img_3
                  }
                  alt=""
            ...
            <p className={`${!item.show ? "need-left" : ""}`}>
              {rankMsg[index] ? rankMsg[index].minter_name : item.name}
            </p>
            <div className="icon-box">
              <div>
                <img
                  src={rankMsg[index] ? rankMsg[index].minter_avatar_url : ""}
                  alt=""
                />
                <span>
                  {calsAddress(rankMsg[index] ? rankMsg[index].minter : "")}
                </span>
              </div>
